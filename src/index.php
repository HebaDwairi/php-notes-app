        ...
        <div class="flex flex-col lg:flex-row gap-8 ">
            ...
            <div class=" mx-auto p-6 shadow-md rounded-xl space-y-4 bg-slate-700 text-slate-300 w-full lg:w-1/3 lg:sticky lg:top-24 self-start">
                ...
                <form action="add_note.php" 
                    ...
                    <div class="space-y-4">
                        <div>
                        <label for="title" class="block text-sm text-slate-400 mb-1">Title:</label>
                        <input
                            type="text"
                            name="title"
                            placeholder="Title"
                        ...
                        <div>
                        <label for="content" class="block text-sm text-slate-400 mb-1">Content</label>
                        <textarea
                            name="content"
                            placeholder="Content"
                            required
                ...
                <ul class="space-y-4">
                    ...
                    try {
                        ...
                        foreach ($notes as $note): ?>
                            <li class='bg-slate-800/50 p-4 rounded-xl border border-transparent hover:text-accent hover:border-accent transition-colors duration-300 group'>
